...
<div class="home">
    ...
    <img src="<?php echo theme_image('work-zipper-tag.png'); ?>" class="header-zippertag-img1">
  </div> 
    ...
    <img src="<?php echo theme_image('work-landing-footer-1.png'); ?>" class="landing-page-footer">
  </div>
