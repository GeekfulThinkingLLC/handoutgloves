			...
			<div class="col-md-12 col-lg-4 snow-productpage-header" style="background:url('<?php echo theme_image('HO Snow6.png'); ?>') no-repeat center center;background-size: 90% 90%;">
			  ...
			  <div class="form-group">
				  <div class="row justify-content-center product-landing-size-focus">
		    		<button type="button" class="size-buttons" id="exampleInputPassword1" placeholder="XS">XS</button>
		    		<button type="button" class="size-buttons" id="exampleInputPassword1" placeholder="S">S</button>
		    		<button type="button" class="size-buttons" id="exampleInputPassword1" placeholder="M">M</button>
		    		<button type="button" class="size-buttons" id="exampleInputPassword1" placeholder="L">L</button>
		    		<button type="button" class="size-buttons" id="exampleInputPassword1" placeholder="XL">XL</button>
		  		</div>
		  	</div>
	  		<div class="form-group">
